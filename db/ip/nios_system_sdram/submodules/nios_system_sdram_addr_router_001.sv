...
(
    ...
    localparam PAD19 = log2ceil(64'h1130 - 64'h1120); 
    localparam PAD20 = log2ceil(64'h2000 - 64'h1800); 
    localparam PAD21 = log2ceil(64'h2010 - 64'h2000); 
    localparam PAD22 = log2ceil(64'h2020 - 64'h2010); 
    localparam PAD23 = log2ceil(64'h2028 - 64'h2020); 
    localparam PAD24 = log2ceil(64'h6000000 - 64'h4000000); 
    // -------------------------------------------------------
    ...
    // ( 0x1120 .. 0x1130 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 27'h1120   ) begin
            src_channel = 25'b1000000000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x1800 .. 0x2000 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 27'h1800   ) begin
            src_channel = 25'b0000000000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x2000 .. 0x2010 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 27'h2000   ) begin
            src_channel = 25'b0000000000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 24;
    end

    // ( 0x2010 .. 0x2020 )
    if ( {address[RG:PAD22],{PAD22{1'b0}}} == 27'h2010   ) begin
            src_channel = 25'b0000000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x2020 .. 0x2028 )
    if ( {address[RG:PAD23],{PAD23{1'b0}}} == 27'h2020   ) begin
            src_channel = 25'b0000000000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x4000000 .. 0x6000000 )
    if ( {address[RG:PAD24],{PAD24{1'b0}}} == 27'h4000000   ) begin
